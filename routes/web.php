...
use App\Http\Controllers\KeguruanController;
use App\Http\Controllers\PrestasiController;
use App\Http\Controllers\ViewPostController;
use App\Http\Controllers\FasilitasController;
use App\Http\Controllers\PerizinanController;
use phpDocumentor\Reflection\Types\Resource_;
use App\Http\Controllers\ViewPrestasiController;
...
Route::get('/tentang/keguruan',[KeguruanController::class,'index']);
Route::get('/tentang/keguruan/{guru:slug}',[KeguruanController::class,'show']);
Route::get('/tentang/prestasi/', [ViewPrestasiController::class, 'index']);
Route::get('/tentang/prestasi/{lomba:slug}', [ViewPrestasiController::class, 'show']);
Route::get('/pintasan', [PintasanController::class, 'index']);
...
Route::get('/admin/prestasi/check_slug', [PrestasiController::class, 'check_slug'])->middleware('auth');
Route::resource('/admin/prestasi', PrestasiController::class)->middleware('author');
