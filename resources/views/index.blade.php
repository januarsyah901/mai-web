...
<body>
    <div class="content-wrapper">
        ...
        <section class="wrapper bg-light">
            <div class="row mb-2">
                <div class="col-md-10 col-xl-9 col-xxl-7 mx-auto text-center">
                  <h1 class="display-2 mb-3 px-lg-14">Keguruan</h1>
                </div>                
                <!--/column -->
              </div>
            <div class="container py-14 py-md-16">
                ...
                <div class="row gy-6 mt-3 mt-md-5">
                  <div class="col-md-6 col-lg-4">
                    <div class="pricing card text-center">
                      <div class="card-body">
                        {{-- <img class="rounded-circle w-20 mb-4" src="/assets/assets/img/photos/mai/RI-2 - Copy.png" srcset="/assets/assets/img/photos/mai/RI-2 - Copy.png" alt="" /> --}}
                        <h4 class="mb-1"><a class="text-navy" href="/tentang/keguruan/abah-akbar">Dr. H. Muhammad Al-Barra, Lc, M. Hum</a></h4>
                        <div class="meta mb-2"><a class="text-navy" href="/tentang/keguruan/abah-akbar">Ketua Yayasan Pondok Pesantren</a></div>
                      </div>
                      <!--/.card-body -->
                    </div>
                    <!--/.pricing -->
                  ...
                  <div class="col-md-6 col-lg-4 popular">
                    <div class="pricing card text-center">
                      <div class="card-body">
                        {{--  <img class="rounded-circle w-20 mb-4" src="/assets/assets/img/photos/mai/RI-2 - Copy.png" srcset="/assets/assets/img/photos/mai/RI-2 - Copy.png" alt="" /> --}} 
                        <h4 class="mb-1"><a class="text-navy" href="/tentang/keguruan/abah-yai">Prof. Dr. KH. Asep Saifudin Chalim, MA</a></h4>
                        <div class="meta mb-2"><a class="text-navy" href="/tentang/keguruan/abah-yai">Pengasuh Pondok Pesantren</a></div>
                      </div>
                      <!--/.card-body -->
                    </div>
                    <!--/.pricing -->
                  ...
                  <div class="col-md-6 col-lg-4">
                    <div class="pricing card text-center">
                      <div class="card-body">
                        {{-- <img class="rounded-circle w-20 mb-4" src="/assets/assets/img/photos/mai/RI-2 - Copy.png" srcset="/assets/assets/img/photos/mai/RI-2 - Copy.png" alt="" /> --}} 
                        <h4 class="mb-1"><a class="text-navy" href="/tentang/keguruan/abah-mauhib">KH. Mauhibburrahman</a></h4>
                        <div class="meta mb-2"><a class="text-navy" href="/tentang/keguruan/abah-mauhib">Koordinator MA Istimewa</a></div>
                      </div>
                      <!--/.card-body -->
                    </div>
                    <!--/.pricing -->
                  </div>
                  <a href="/tentang/keguruan" class="btn btn-soft-green rounded-pill text-navy">Selengkapnya</a>
                  <!--/column -->
                </div>
                <!--/.row -->
              </div>
        ...
        <!--        <div class="shape bg-dot primary rellax w-16 h-18" data-rellax-speed="1" style="top: 2rem; right: -2.4rem;"></div>-->
        <!--        <div class="shape rounded-circle bg-line red rellax w-18 h-18 d-none d-lg-block" data-rellax-speed="1" style="bottom: 0.5rem; left: -2.5rem;"></div>-->
        <!--        <div class="row gy-6 mt-3 mt-md-5 text-center">-->
        <!--          <div class="col-md-6 col-lg-4">-->
        <!--            <div class="pricing card text-center">-->
        <!--              <div class="card-body">-->
        <!--                <img class="rounded-circle w-20 mb-4" src="/assets/assets/img/photos/mai/RI-2 - Copy.png" srcset="/assets/assets/img/photos/mai/RI-2 - Copy.png" alt="" />-->
        <!--                <h4 class="mb-1"><a class="text-navy" href="/tentang/prestasi">Akademik</a></h4>-->
        <!--              </div>-->
                      <!--/.card-body -->
        <!--            </div>-->
                    <!--/.pricing -->
        ...
        <!--              <div class="card-body">-->
        <!--                <img class="w-23 mb-4" src="/assets/assets/img/photos/mai/trophy.png" srcset="/assets/assets/img/photos/mai/RI-2 - Copy.png" alt="" />-->
        <!--              </div>-->
                      <!--/.card-body -->
        <!--            </div>-->
                    <!--/.pricing -->
        ...
        <!--              <div class="card-body">-->
        <!--                <img class="rounded-circle w-20 mb-4" src="/assets/assets/img/photos/mai/RI-2 - Copy.png" srcset="/assets/assets/img/photos/mai/RI-2 - Copy.png" alt="" />-->
        <!--                <h4 class="mb-1"><a class="text-navy" href="/tentang/prestasi">Non-Akademik</a></h4>-->
        <!--              </div>-->
                      <!--/.card-body -->
        <!--            </div>-->
                    <!--/.pricing -->
