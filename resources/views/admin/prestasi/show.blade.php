        ...
        <div class="card card-primary">
            ...
            <form method="POST" action="/admin/post">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('category_id') is-invalid @enderror" id=""
                            placeholder="Input Kategori" value="{{ old('category_id', $post->category_id) }}" name="category_id" readonly="readonly" required>
                        @error('category_id')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="card-footer">
                    <a href="/admin/prestasi" class="btn btn-primary">Back</a>
                </div>
            </form>
        </div>
    </div>
