    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Tabel Postingan Terbaru</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                            ...
                            <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="anggal Post: activate to sort column ascending">Tanggal
                                            Post</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($d->created_at)->isoFormat('D MMM Y') }}</td>
                                        <td>{{ $d->judul }}</td>
                                        <td>{{ $d->category_id }}</td>
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-success">
                                                    <a href="/admin/prestasi/{{ $d->id }}" class="text-white"><i
                                                            class="far fa-eye"></i></a>
                                                </button>
                                                <button type="button" class="btn btn-warning">
                                                    <a href="/admin/prestasi/{{ $d->id }}/edit" class="text-white"><i
                                                ...
                                                <form action="/admin/prestasi/{{ $d->id }}" method="POST" class="">
                                                    @method('delete')
                                                    @csrf
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th rowspan="1" colspan="1">Tanggal Post</th>
