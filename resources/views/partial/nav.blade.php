<div class="container flex-lg-row flex-nowrap align-items-center">
    <div class="navbar-brand w-100 navbar-MAI">
        ...
        @if (request()->is('/'))
            <div class="navbar-text">
                <h4 class="navbar-heading text-light">MAI Amanatul Ummah <br> Program Istimewa</h4>
                {{-- <h4 class="navbar-heading text-light">Layanan SKS 2 dan 3 Tahun</h4> --}}
            </div>
        @else
            <div class="navbar-text">
                <h4 class="navbar-heading text-dark">MAI Amanatul Ummah <br> Program Istimewa</h4>
                {{-- <h4 class="navbar-heading text-light">Layanan SKS 2 dan 3 Tahun</h4> --}}
            </div>
        @endif
    </div>
    <div class="navbar-collapse offcanvas-nav">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item"><a class="nav-link" href="/post">Berita</a></li>
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#!">Tentang MAI</a>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="nav-item"><a class="dropdown-item" href="/assets/services2.html">Services II</a></li>
                    ...
                    <li class="nav-item"><a class="dropdown-item" href="/tentang/keguruan">Tenaga Kependidikan</a></li>
                    <li class="nav-item"><a class="dropdown-item" href="/tentang/layanan">Program</a></li>
                    <li class="nav-item"><a class="dropdown-item" href="/tentang/prestasi">Prestasi</a></li>
